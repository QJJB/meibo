...
const NavBarVertical = () => {
    ...
    return (
        <div className="w-16 h-[calc(100vh-100px)] bg-dark-primary mt-[50px] mb-[50px] pl-9 pr-9 flex flex-col justify-between items-center">
            ...
            <div className="flex flex-col items-center space-y-6 hover: cursor-pointer">
            ...
            <div className="flex flex-col items-center space-y-6">
                ...
                <div className={`${hoverBg}`}>
                    <NavLink href={route("logout")} method="post" className="hover: cursor-pointer">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M17 16L21 12M21 12L17 8M21 12L7 12M13 16V17C13 18.6569 11.6569 20 10 20H6C4.34315 20 3 18.6569 3 17V7C3 5.34315 4.34315 4 6 4H10C11.6569 4 13 5.34315 13 7V8" stroke="#D22A2A" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    </NavLink>
                </div>
            </div>
