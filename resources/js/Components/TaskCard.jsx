    ...
    return (
        <>
            {tasks.map((task) => (
                ...
                <div className='task-card bg bg-dark-tertiary [width:calc(100%-30px)] mx-auto rounded-[20px] hover:w-full'>
                    ...
                    <div className="task-card-header flex flex-row items-center justify-between mt-[22px] mx-[15px] w-[calc(100%-30px)]">
                        ...
                        <div className="task-card-date flex flex-row space-x-[10px] items-center justify-between">
                            <p className='text-yellow-meibo font-light text-[17px] [letter-spacing:-0.05em]'>{task.due_date ? task.due_date.slice(0, 10) : 'Pas de date'}</p>
                    ...
                    <div className="task-card-container flex items-center justify-between bg-yellow-meibo [width:calc(100%-30px)] pl-[19px] pt-[19px] p-[19px] mx-[15px] rounded-[20px] mb-[15px] mt-[15px]">
                        <div className="task-card-description flex flex-col w-[224px] space-y-[8px]">
                            <p className='text-dark-primary text-[17px] font-semibold [letter-spacing:-0.05em] leading-[21px]'>{projects.name}</p>
                        </div>
                    </div>
                </div>
            ))}
