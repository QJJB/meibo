    ...
    return (
        <div className="space-y-6">
            {tasks.map((task) => (
                <div
                    key={task.id}
                    className="task-card bg bg-dark-tertiary w-[calc(100%-30px)] mx-auto h-[192px] rounded-[20px]"
                >
                    <div className="task-card-header flex flex-row items-center justify-between mt-[22px] mx-[15px] w-[calc(100%-30px)]">
                        ...
                        <div className="task-card-date flex flex-row space-x-[10px] items-center justify-between">
                            <p className="text-yellow-meibo font-light text-[17px] [letter-spacing:-0.05em]">
                                {task.due_date ? task.due_date : 'Pas de date'}
                            </p>
                            <svg className="w-6 h-6 stroke-yellow-meibo transition-transform" width="26" height="24" viewBox="0 0 26 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="task-card-container flex items-center justify-between bg-yellow-meibo w-[calc(100%-30px)] h-[55%] mx-[15px] rounded-[20px] mb-[15px] mt-[15px]">
                        <div className="task-card-description flex flex-col w-[224px] space-y-[8px] ml-[24px] mb-[60px]">
                            <p className="text-dark-primary text-[15px] font-medium [letter-spacing:-0.05em]">
                                Priorité : {task.priority}
                            </p>
                            <p className="text-dark-primary text-[17px] font-medium [letter-spacing:-0.05em] leading-[21px]">
                                {task.description}
                            </p>
                        </div>
